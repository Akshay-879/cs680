...
public class ApfsDirectory extends ApfsElement {
    ...
    public ApfsDirectory(String name, int size,  String owner ,LocalDateTime creationTime, LocalDateTime lastModification,ApfsDirectory parent) {
        super(name, size,owner,creationTime,lastModification,parent);
    }
