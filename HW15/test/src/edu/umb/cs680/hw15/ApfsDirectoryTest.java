...
class ApfsDirectoryTest {
    ...
    void testFileName() {
        ...
        assertSame("a", root.getSubDirectories().get(0).findFileByName("a").getName());
    ...
    void testdirectory() {
        ...
        assertFalse(root.getSubDirectories().get(1).findFileByName("c").isDirectory());
    }
    ...
    @Test
    public void testDirectoryEqualityCodefile() {
        APFS FilesystemofApfs = APFS.getAPFSFileSystem();
        ApfsDirectory root = (ApfsDirectory)FilesystemofApfs.getRootDir();
